...
LOCAL_SRC_FILES := \
                   ...
                   $(subst $(LOCAL_PATH)/,, \
                       $(wildcard $(LOCAL_PATH)/../../src/game/setup/*.cpp)) \
                   $(subst $(LOCAL_PATH)/,, \
                       $(wildcard $(LOCAL_PATH)/../../src/game/flags/*.cpp)) \
                   $(subst $(LOCAL_PATH)/,, \
                       $(wildcard $(LOCAL_PATH)/../../src/game/components/*.cpp)) \
                   $(subst $(LOCAL_PATH)/,, \
                       $(wildcard $(LOCAL_PATH)/../../src/game/update/*.cpp)) \
                   $(subst $(LOCAL_PATH)/,, \
                       $(wildcard $(LOCAL_PATH)/../../src/game/jumpballs/*.cpp)) \
                   $(subst $(LOCAL_PATH)/,, \
                       $(wildcard $(LOCAL_PATH)/../../src/game/offense/*.cpp)) \
                   $(subst $(LOCAL_PATH)/,, \
                       $(wildcard $(LOCAL_PATH)/../../src/game/defense/*.cpp)) \
