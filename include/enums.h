...
#define _ENUMS_H_
    ...
    enum inputKeyMaps  // maps input to appropriate keys
    {
        ...
        INKEY_LEFT = 'left',
        INKEY_RIGHT = 'right',
        INKEY_SCROLLLOCK = 'scrolllock',
        INKEY_HOME = 'home',
        INKEY_PRTSCN = 'prtscn',
        INKEY_PAUSE_BREAK = 'pausebreak',
        INKEY_INSERT = 'insert',
        INKEY_DELETE = 'delete',
        INKEY_PAGEUP = 'pageup',
        INKEY_PAGEDOWN = 'pagedown',
        INKEY_END = 'end',
        INKEY_NUMLOCK = 'numlock',
        INKEY_DIVIDE = 'divide',
        INKEY_MULTIPLY = 'multiply',
        INKEY_MINUS = 'minud',
        INKEY_PLUS = 'plus',
        INKEY_ENTER = 'enter',
        INKEY_PERIOD = '.',
