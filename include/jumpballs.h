...
class jumpBalls
{
    ...
    bool jumpBallExecute(basketballEntityMSharedPtr activeBasketballInstance, teamEntityMSharedPtr activeTeamInstance); // initiates jump ball from jump ball circle
