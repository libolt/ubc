...
#ifndef _playerStateTest_H_
#define _playerStateTest_H_
...
//        bool stateSet;  // if true the playerStateTest object has been set to initial state
        // temporary hack
        bool initialized;
