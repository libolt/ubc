...
/*bool gameEntity::loadBasketballModel()  // loads selected basketball model
{
    conversionSharedPtr convert = conversion::Instance();
...
//    size_t activeBBallInstance = getActiveBBallInstance();
    basketballStateMSharedPtr basketballInstance = getBasketballInstance();
    std::string func = "gameEntity::loadBasketballModel()";
...
/* bool gameEntity::loadCourtModel()  // loads selected court model
{
    conversionSharedPtr convert = conversion::Instance();
    loaderSharedPtr load(new loader);
    courtStateMSharedPtr courtInstance = getCourtInstance();
    ...
    bool returnType = false;
    std::string func = "gameEntity::loadCourtModel()";
...
/*bool gameEntity::loadHoopModel()  // loads selected hoop model
{
    conversionSharedPtr convert = conversion::Instance();
    hoopStateMSharedPtr activeHoopInstance = getActiveHoopInstance();
    loaderSharedPtr load(new loader);
    std::string func = "gameEntity::loadHoopModel()";
    bool returnType = true;
...
/*bool gameEntity::loadModels(renderEngineSharedPtr render)  // loads all game object models excluding the players
{
    conversionSharedPtr convert = conversion::Instance();
    bool returnType = true;
    std::string func = "gameEntity::loadModels()";
    logMsg(func +" begin");
...
bool gameEntity::createNodes(renderEngineSharedPtr render)  // creates scene nodes for game objects
{
    ...
    std::string func = "gameEntity::createNodes()";
...
void gameEntity::setBasketballStartPositions()  // sets the initial coordinates for the basketball(s)
{
    conversionSharedPtr convert = conversion::Instance();
//    size_t activeBBallInstance = getActiveBBallInstance();
